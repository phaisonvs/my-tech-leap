      ...
      >
        ...
        >
          ...
          <p className="text-sm md:text-lg text-muted-foreground max-w-2xl mx-auto leading-snug md:leading-normal break-words">
            Hoje eu lidero, na prática, frentes de UX/UI, front-end,
            integrações, tracking e sustentação que impactam diretamente a
            conversão, a operação e a evolução dos KPIs do funil.
          </p>
        </div>
